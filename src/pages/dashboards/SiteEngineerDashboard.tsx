...
export const SiteEngineerDashboard = () => {
  ...
  const dynamicKpiCards = useMemo(() => {
    return [
      ...
      { id: 'ppe-compliance', title: 'PPE Compliance', value: safetyScoreVal, trend: '+0.5%', isPositive: true, icon: 'bi-person-check-fill', badgeClass: 'bg-success-subtle text-success border border-success-subtle' },
    ];
  }, [progressVal, totalWorkersVal, machineryVal, qualityAuditsVal, aiAlertsVal, safetyScoreVal]);
      ...
      <section className="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-2">
        ...
        <div className="d-flex align-items-center gap-2">
          ...
          >
            ...
            <span>Alert Center ({activeAlertsList.length})</span>
          </button>
        </div>
      </section>
